...
local sicko_intro = {
    ...
    functions = {
        init = function(self)
            ...
            Input:rumble(self.peter.controllerId, .4, .3)
            ...
            self.coil.wait(1.4)
            Input:rumble(self.peter.controllerId, .8, .3)
            ...
            Input:rumble(self.peter.controllerId, .2, .3)
            Input:rumble(self.timon.controllerId, .3, .3)
            self.coil.wait(.5)
